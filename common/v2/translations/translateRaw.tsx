...
//import { ISettingsContext } from 'v2/services/Store';
// import { SettingsContext } from 'v2/services/Store/Settings';
...
export function translateRaw(key: string, variables?: { [name: string]: string }): string {
  ...
  // console.log("1 ...");
  // console.log(SettingsContext);
  //const languageConfig = useContext(SettingsContext);
  //console.log(languageConfig.language)
  // console.log("xxl useContext ....:" + languageConfig.language)
  // const language =  languageConfig.language
  ///
  //console.log("xxl language " + language);
  //console.log("xxl fallbackLanguage " + fallbackLanguage);
