    ...
    return (
      <div className="Panel">
        <div className="Panel-title">
          {translate('UNLOCK_WALLET')} {`${translateRaw('X_KEYSTORE2')}`}
        </div>
        <div className="Keystore">
          <form onSubmit={this.unlock}>
            <div className="form-group">
              ...
              />
              <label>{translate('YOUR_KEYSTORE_LABEL')}</label>
              ...
              <label className="Keystore-password">{translate('SIGN_TX_YOUR_PASSWORD')}</label>
              <Input
