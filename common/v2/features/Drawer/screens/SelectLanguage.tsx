...
const handleLanguageSelect = (
  ...
  // console.log("xxl handleLanguageSelect code " + code);
  // console.log("xxl handleLanguageSelect languageSelection " + languageSelection);
  // console.log("xxl handleLanguageSelect changeLanguage " + changeLanguage);
