...
export const socialMediaLinks: Link[] = [
  {
    link: 'https://twitter.com/haichain',
    text: 'twitter'
  },
  {
    link: 'https://www.facebook.com/haichain/',
    text: 'facebook'
  },
  {
    link: 'https://medium.com/@haichain',
    text: 'medium'
  },
  {
    link: 'https://www.linkedin.com/company/haichain',
    text: 'linkedin'
  },
  {
    link: 'https://github.com/haichain',
    text: 'github'
  },
  {
    link: 'https://www.reddit.com/r/haichain/',
    text: 'reddit'
  },
  {
    link: discordURL,
...
export const productLinks: Link[] = [
  {
    link: 'https://legacy.haichain.com/',
    text: translateRaw('OLD_MYCRYPTO')
  },
  {
    link: 'https://chrome.google.com/webstore/detail/etheraddresslookup/haichain',
    text: translateRaw('ETHER_ADDRESS_LOOKUP')
  },
  {
    link: 'https://chrome.google.com/webstore/detail/ethersecuritylookup/haichain',
  ...
  {
    link: 'https://legacy.haichain.com/helpers.html',
    text: translateRaw('FOOTER_HELP_AND_DEBUGGING')
  },
  {
    link: 'https://hackerone.com/haichain',
